...
urlpatterns = [
    ...
    path('reservations/<int:booking_id>/status/', views.update_reservation_status, name='update_reservation_status'),
    ...
    path('properties/<str:service_type>/<int:property_id>/availability/', views.set_property_availability, name='set_property_availability'),
