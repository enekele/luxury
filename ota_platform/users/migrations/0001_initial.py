    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_spent_currency', djmoney.models.fields.CurrencyField(choices=[('AUD', 'Australian Dollar'), ('GBP', 'British Pound'), ('CAD', 'Canadian Dollar'), ('CNY', 'Chinese Yuan'), ('EUR', 'Euro'), ('JPY', 'Japanese Yen'), ('NZD', 'New Zealand Dollar'), ('SEK', 'Swedish Krona'), ('CHF', 'Swiss Franc'), ('USD', 'US Dollar')], default='USD', editable=False, max_length=3)),
                ('total_spent', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passport_expires', models.DateField(blank=True, null=True)),
                ('frequent_flyer_numbers', models.JSONField(blank=True, default=dict)),
